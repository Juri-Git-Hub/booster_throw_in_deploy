...
class SafetyCfg:
    ...
    max_target_velocity: List[float] = MISSING
    runtime_max_target_velocity: Optional[List[float]] = None
    startup_steps: int = 0
    joint_pos_lower: List[float] = MISSING
    joint_pos_upper: List[float] = MISSING
